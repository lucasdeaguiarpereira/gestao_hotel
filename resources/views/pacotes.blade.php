                                ...
                                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg" style="border-radius:20px;">
                                    <div class="container row mt-4 mb-4">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-6">
                                                    <button type="button" onclick="modalEditarPacote(`+pacote.id+`)" style="color:white;background-color:#71BF94;display:inline-flex;" class="btn rounded-pill">
